<?php
  //List of courses as seen by a faculty member
  session_start();
    ...
    <body>
        ...
        ?>
            <tr class="table table-striped">
                ...
                <td><center><a href="view_script.php?cid=<?php echo $row['id']?>"><button class="btn btn-primary">View Students Registered</button></a></center></td>
            </tr>
        <?php
           }
        ?>
